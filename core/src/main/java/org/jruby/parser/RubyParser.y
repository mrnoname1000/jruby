...
%type <RubySymbol> f_norm_arg 
%type <ByteList> restarg_mark
...
%type <ByteList> kwrest_mark
%type <RubySymbol> f_label f_kwrest
...
top_stmt      : stmt
              | keyword_BEGIN tLCURLY top_compstmt tRCURLY {
                    support.getResult().addBeginNode(new PreExeNode($1.intValue(), support.getCurrentScope(), $3));
                    $$ = null;
              }
...
// FIXME: How can this new begin ever work?  is yyerror conditional in MRI?
                | keyword_begin {
                    ...
                    $$ = new BeginNode($1.intValue(), support.makeNullNil($2));
                }
...
stmt            : keyword_alias fitem {
                ...
                | keyword_alias tGVAR tBACK_REF {
                    $$ = new VAliasNode($1.intValue(), $2, support.symbolID(lexer, $<BackRefNode>3.getByteName()));
                }
                ...
                | stmt modifier_if expr_value {
                    $$ = new IfNode(support.getLine($1), support.getConditionNode($3), $1, null);
                    support.fixpos($<Node>$, $3);
                }
                | stmt modifier_unless expr_value {
                    $$ = new IfNode(support.getLine($1), support.getConditionNode($3), null, $1);
                    support.fixpos($<Node>$, $3);
                }
                | stmt modifier_while expr_value {
                    if ($1 != null && $1 instanceof BeginNode) {
                        $$ = new WhileNode(support.getLine($1), support.getConditionNode($3), $<BeginNode>1.getBodyNode(), false);
                    } else {
                        $$ = new WhileNode(support.getLine($1), support.getConditionNode($3), $1, true);
                    }
                }
                | stmt modifier_until expr_value {
                    if ($1 != null && $1 instanceof BeginNode) {
                        $$ = new UntilNode(support.getLine($1), support.getConditionNode($3), $<BeginNode>1.getBodyNode(), false);
                    } else {
                        $$ = new UntilNode(support.getLine($1), support.getConditionNode($3), $1, true);
                    }
                }
...
command_asgn    : lhs '=' command_rhs {
                ...
                | var_lhs tOP_ASGN command_rhs {
                    ...
                    int line = $1.getLine();
                    ByteList asgnOp = $2.getBytes();
                    if (asgnOp.equals(lexer.OR_OR)) {
                        $1.setValueNode($3);
                        $$ = new OpAsgnOrNode(support.gettable2($1), $1);
  ...
  // FIXME: arg_concat logic missing for opt_call_args
                ...
                | primary_value call_op tIDENTIFIER tOP_ASGN command_rhs {
                    $$ = support.newOpAsgn($1, $2, $5, $3, $4);
                }
                | primary_value call_op tCONSTANT tOP_ASGN command_rhs {
                    $$ = support.newOpAsgn($1, $2, $5, $3, $4);
                }
                | primary_value tCOLON2 tCONSTANT tOP_ASGN command_rhs {
                    $$ = support.newOpConstAsgn(support.new_colon2($1, $3), $4, $5);
                }
...
command        : fcall command_args %prec tLOWEST {
                ...
                | keyword_super command_args {
                    $$ = support.new_super($1.intValue(), $2);
                }
                | keyword_yield command_args {
                    $$ = support.new_yield($1.intValue(), $2);
                }
                | k_return call_args {
                    $$ = new ReturnNode($1.intValue(), support.ret_args($2, $1.intValue()));
                }
                | keyword_break call_args {
                    $$ = new BreakNode($1.intValue(), support.ret_args($2, $1.intValue()));
                }
                | keyword_next call_args {
                    $$ = new NextNode($1.intValue(), support.ret_args($2, $1.intValue()));
                }
...
mlhs_inner      : mlhs_basic {
                ...
                | tLPAREN mlhs_inner rparen {
                    $$ = new MultipleAsgnNode($1.intValue(), support.newArrayNode($1.intValue(), $2), null, null);
                }
...
mlhs_basic      : mlhs_head {
                ...
                | mlhs_head tSTAR {
                    $$ = new MultipleAsgnNode($1.getLine(), $1, new StarNode(lexer.getLine()), null);
                }
                | mlhs_head tSTAR ',' mlhs_post {
                    $$ = new MultipleAsgnNode($1.getLine(), $1, new StarNode(lexer.getLine()), $4);
                }
                | tSTAR mlhs_node {
                ...
                | tSTAR {
                      ...
                      $$ = new MultipleAsgnNode(line, null, new StarNode(line), null);
                }
                | tSTAR ',' mlhs_post {
                      int line = lexer.getLine();
                      $$ = new MultipleAsgnNode(line, null, new StarNode(line), $3);
                }
...
mlhs_node       : /*mri:user_variable*/ tIDENTIFIER {
                ...
                | primary_value tCOLON2 tCONSTANT {
                    ...
                    $$ = new ConstDeclNode(support.new_colon2($1, $3));
                }
                | tCOLON3 tCONSTANT {
                    if (support.isInDef()) {
...
// LiteralNode:fsym
fsym           : fname {
                   $$ = new LiteralNode(lexer.getLine(), $1);
               }
               | symbol {
                   $$ = new LiteralNode(lexer.getLine(), $1);
               }
...
arg             : lhs '=' arg_rhs {
                    ...
                    $<Node>$.setLine(support.getLine($1));
                }
  ...
  // FIXME: arg_concat missing for opt_call_args
                ...
                | tCOLON3 tCONSTANT tOP_ASGN arg_rhs {
                    $$ = support.newOpConstAsgn(new Colon3Node(lexer.getLine(), $2), $3, $4);
                }
                ...
                | arg tDOT2 arg {
                    ...
                    $$ = new DotNode(support.getLine($1), support.makeNullNil($1), support.makeNullNil($3), false, isLiteral);
                }
                | arg tDOT3 arg {
                    value_expr(lexer, $1);
                    value_expr(lexer, $3);
                ...
                | arg '?' arg opt_nl ':' arg {
                    value_expr(lexer, $1);
                    $$ = new IfNode(support.getLine($1), support.getConditionNode($1), $3, $6);
                }
                | primary {
                    $$ = $1;
                }
...
call_args       : command {
                    value_expr(lexer, $1);
                    $$ = support.newArrayNode(support.getLine($1), $1);
                }
                | args opt_block_arg {
...
primary         : literal
                ...
                | tLBRACK aref_args tRBRACK {
                    if ($2 == null) {
                        $$ = new ZArrayNode(lexer.getLine()); /* zero length array */
                    } else {
                        $$ = $2;
                    }
                }
                ...
                | keyword_yield tLPAREN2 call_args rparen {
                    $$ = support.new_yield($1.intValue(), $3);
                }
                ...
                | keyword_case expr_value opt_terms case_body keyword_end {
                    $$ = support.newCaseNode($1.intValue(), $2, $4);
                }
                | keyword_case opt_terms case_body keyword_end {
                    $$ = support.newCaseNode($1.intValue(), null, $3);
                }
                ...
                | k_class cpath superclass {
                    ...
                    $$ = new ClassNode($1, $<Colon3Node>2, support.getCurrentScope(), body, $3, lexer.getLine());
                ...
                | k_class tLSHFT expr {
                    ...
                    $$ = new SClassNode($1, $3, support.getCurrentScope(), body, lexer.getLine());
                    support.popCurrentScope();
                ...
                | k_module cpath {
                    ...
                    $$ = new ModuleNode($1, $<Colon3Node>2, support.getCurrentScope(), body, lexer.getLine());
                    support.popCurrentScope();
                ...
                | keyword_def fname {
                    ...
                    $$ = new DefnNode($1, $2, (ArgsNode) $5, support.getCurrentScope(), body, $7.intValue());
                    support.popCurrentScope();
                ...
                | keyword_def singleton dot_or_colon {
                    ...
                    $$ = new DefsNode($1, $2, $5, (ArgsNode) $7, support.getCurrentScope(), body, $9.intValue());
                    support.popCurrentScope();
                    support.setInDef($<Boolean>4.booleanValue());
...
f_margs         : f_marg_list {
                ...
                | f_marg_list ',' tSTAR ',' f_marg_list {
                    $$ = new MultipleAsgnNode($1.getLine(), $1, new StarNode(lexer.getLine()), $5);
                }
                | tSTAR f_norm_arg {
                    $$ = new MultipleAsgnNode(lexer.getLine(), null, support.assignableInCurr($2, null), null);
                }
                | tSTAR f_norm_arg ',' f_marg_list {
                    $$ = new MultipleAsgnNode(lexer.getLine(), null, support.assignableInCurr($2, null), $4);
                }
                | tSTAR {
                    $$ = new MultipleAsgnNode(lexer.getLine(), null, new StarNode(lexer.getLine()), null);
                }
                | tSTAR ',' f_marg_list {
                    $$ = new MultipleAsgnNode(support.getLine($3), null, null, $3);
                }
...
block_args_tail : f_block_kwarg ',' f_kwrest opt_f_block_arg {
                ...
                | f_block_kwarg opt_f_block_arg {
                    $$ = support.new_args_tail($1.getLine(), $1, (RubySymbol) null, $2);
                }
                | f_kwrest opt_f_block_arg {
                    $$ = support.new_args_tail(lexer.getLine(), null, $1, $2);
                }
                | f_block_arg {
                    $$ = support.new_args_tail($1.getLine(), null, (RubySymbol) null, $1);
                }
...
opt_block_args_tail : ',' block_args_tail {
                ...
                | /* none */ {
                    $$ = support.new_args_tail(lexer.getLine(), null, (RubySymbol) null, null);
                }
...
block_param     : f_arg ',' f_block_optarg ',' f_rest_arg opt_block_args_tail {
                ...
                | f_block_optarg ',' f_rest_arg opt_block_args_tail {
                    $$ = support.new_args(support.getLine($1), null, $1, $3, null, $4);
                }
                | f_block_optarg ',' f_rest_arg ',' f_arg opt_block_args_tail {
                    $$ = support.new_args(support.getLine($1), null, $1, $3, $5, $6);
                }
                | f_block_optarg opt_block_args_tail {
                    $$ = support.new_args(support.getLine($1), null, $1, null, null, $2);
                }
...
opt_block_param : none {
    // was $$ = null;
                    $$ = support.new_args(lexer.getLine(), null, null, null, null, (ArgsTailHolder) null);
                }
                | block_param_def {
...
method_call     : fcall paren_args {
                ...
                | primary_value call_op paren_args {
                    $$ = support.new_call($1, $2, support.symbolID(lexer, LexingCommon.CALL), $3, null);
                }
                | primary_value tCOLON2 paren_args {
                    $$ = support.new_call($1, support.symbolID(lexer, LexingCommon.CALL), $3, null);
                }
                ...
                | primary_value '[' opt_call_args rbracket {
                    if ($1 instanceof SelfNode) {
                        $$ = new FCallNode(lexer.tokline, support.symbolID(lexer, LexingCommon.LBRACKET_RBRACKET));
                        support.frobnicate_fcall_args($<FCallNode>$, $3, null);
                    } else {
                      $$ = support.new_call($1, support.symbolID(lexer, LexingCommon.LBRACKET_RBRACKET), $3, null);
                    }
                }
...
brace_body      : {
                    ...
                    $$ = new IterNode($<Integer>1.intValue(), $3, $4, support.getCurrentScope());
                    support.popCurrentScope();
                    lexer.getCmdArgumentState().reset($<Long>2.longValue());
                }
...
case_body       : keyword_when args then compstmt cases {
                    $$ = support.newWhenNode($1.intValue(), $2, $4, $5);
                }
...
opt_rescue      : keyword_rescue exc_list exc_var then compstmt opt_rescue {
                    Node node;
                    if ($3 != null) {
                        node = support.appendToBlock(lexer, support.node_assign($3, new GlobalVarNode($1, support.symbolID(lexer, lexer.DOLLAR_BANG))), $5);
                        if ($5 != null) {
...
literal         : numeric {
                ...
                | symbol {
                    $$ = new SymbolNode(lexer.getLine(), $1);
                }
                | dsym
...
string_content  : tSTRING_CONTENT {
                ...
                | tSTRING_DVAR {
                    ...
                    $$ = new EvStrNode(support.getLine($3), $3);
                }
                | tSTRING_DBEG {
                   $$ = lexer.getStrTerm();
                   lexer.setStrTerm(null);
...
// RubySymbol:f_kwrest - [!null]
f_kwrest        : kwrest_mark tIDENTIFIER {
                    support.shadowing_lvar($2);
                    $$ = $2;
                }
                | kwrest_mark {
                    $$ = support.symbolID(lexer, support.INTERNAL_ID);
                }

f_opt           : f_arg_asgn '=' arg_value {
                    lexer.setCurrentArg(null);
                    $$ = new OptArgNode(support.getLine($3), support.assignableLabelOrIdentifier($1.getName(), $3));
                }
...
f_rest_arg      : restarg_mark tIDENTIFIER {
  ...
  // FIXME: bytelist_love: somewhat silly to remake the empty bytelist over and over but this type should change (using null vs "" is a strange distinction).
                    $$ = new UnnamedRestArgNode(lexer.getLine(), support.symbolID(lexer, CommonByteLists.EMPTY), support.getCurrentScope().addVariable("*"));
                }
...
assoc           : arg_value tASSOC arg_value {
                ...
                | tSTRING_BEG string_contents tLABEL_END arg_value {
                    if ($2 instanceof StrNode) {
                        DStrNode dnode = new DStrNode(support.getLine($2), lexer.getEncoding());
                        dnode.add($2);
                        $$ = support.createKeyValue(new DSymbolNode(support.getLine($2), dnode), $4);
                    } else if ($2 instanceof DStrNode) {
                        $$ = support.createKeyValue(new DSymbolNode(support.getLine($2), $<DStrNode>2), $4);
                    } else {
