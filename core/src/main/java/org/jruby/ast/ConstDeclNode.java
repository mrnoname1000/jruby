...
public class ConstDeclNode extends AssignableNode implements INameNode {
    ...
    public ConstDeclNode(Node constNode) {
        super(constNode.getLine(), NilImplicitNode.NIL, false);

        this.name = null;
        this.constNode = (INameNode) constNode;
    }

    public ConstDeclNode(int line, RubySymbol name) {
        super(line, NilImplicitNode.NIL, false);
